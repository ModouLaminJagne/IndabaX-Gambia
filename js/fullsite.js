document.addEventListener("DOMContentLoaded",()=>{const navbarToggler=document.getElementById("navbar-toggler")
    ...
    requestAnimationFrame(updateProgress)});window.onload=function(){window.scrollTo(0,0)};const lyeItems=[{id:1,content:"Image 1",imageUrl:"../assets/previous_year_edition/picture_1.jpg"},{id:2,content:"Image 2",imageUrl:"../assets/previous_year_edition/picture_2.jpg"},{id:3,content:"Image 3",imageUrl:"../assets/previous_year_edition/picture_3.jpg"},{id:4,content:"Image 4",imageUrl:"../assets/previous_year_edition/picture_4.jpg"},{id:5,content:"Image 5",imageUrl:"../assets/previous_year_edition/picture_5.jpg"},{id:6,content:"Image 6",imageUrl:"../assets/previous_year_edition/picture_6.jpg"},{id:7,content:"Image 7",imageUrl:"../assets/previous_year_edition/picture_7.jpg"},{id:8,content:"Image 8",imageUrl:"../assets/previous_year_edition/picture_8.jpg"},{id:9,content:"Image 9",imageUrl:"../assets/previous_year_edition/picture_9.jpg"},{id:10,content:"Image 10",imageUrl:"../assets/previous_year_edition/picture_10.jpg"}];const lyeScroller=document.getElementById('lyeScroller');const lyeScrollerContainer=document.getElementById('lyeScrollerContainer');function createLyeScrollItem(item,index){const scrollItem=document.createElement('div');scrollItem.className='lye-scroll-item';scrollItem.setAttribute('data-id',`lye-${item.id}-${index}`);const img=document.createElement('img');img.src=item.imageUrl;img.alt=item.content||'Last year edition image';img.className='lye-scroll-image';scrollItem.appendChild(img);return scrollItem}
